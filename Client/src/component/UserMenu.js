...
function UserMenu({ user }) {
  ...
  const userLocalStorage = user.i_id
    ? user
    : JSON.parse(localStorage.getItem("doc-user"));
  ...
  return (
    <div className="relative inline-flex">
      ...
      {dropdownOpen && (
        <div className="origin-top-right z-10 absolute top-full right-0 w-max bg-white border border-gray-200 py-1.5 rounded shadow-lg overflow-hidden mt-1">
          <div
            ref={dropdown}
          ...
          >
            <ul>
              <li>
                <Link
                  className="font-medium text-sm text-black hover:text-red-600 flex items-center py-1 px-3"
              ...
              <li>
                <span
                  className="font-medium text-sm text-red-400 hover:text-red-600 flex items-center py-1 px-3 cursor-pointer"
